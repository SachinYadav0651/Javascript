...
// valueOf()       -- object.valueOf();          -- don't know where to use
// used to return the primitive value of an object. 
// It is mainly used in objects that have a custom behavior for conversion to a primitive value
...
// console.log(dateObj.valueOf()); // Returns milliseconds since epoch



// [Symbol.iterator]()      -- let iterator = str[Symbol.iterator]();
// allows you to iterate over the characters of a string. 
// The method returns an iterator object that conforms to the Iterator Protocol, allowing you to loop through the string character by character.

// let str = "hello";

// Create the iterator for the string
// let iterator = str[Symbol.iterator]();

// Iterate over the string using the iterator
...
// toLocaleLowerCase()      -- str.toLocaleLowerCase([locales]);
// Converts a string to lowercase according to the locale. Handling locale-specific case conversion (e.g., Turkish "I")

// let str = "İstanbul";
// console.log(str.toLocaleLowerCase("tr-TR"));  // Outputs: "istanbul"
// console.log(str.toLocaleLowerCase("en-US"));  // Outputs: "istanbul"


// toLocaleUpperCase()      -- str.toLocaleLowerCase([locales]);
// Converts a string to uppercase according to the locale.. Handling locale-specific case conversion (e.g., Turkish "I")

// let str5 = "istanbul";
// console.log(str.toLocaleUpperCase("tr-TR"));  // Outputs: "ISTANBUL"
// console.log(str.toLocaleUpperCase("en-US"));  // Outputs: "ISTANBUL"
